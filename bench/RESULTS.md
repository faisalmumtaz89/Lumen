...
The tiled kernel, its threshold and the single-block kernel named above were since retired: decode attention now runs one kernel at every context (see the CHANGELOG).
