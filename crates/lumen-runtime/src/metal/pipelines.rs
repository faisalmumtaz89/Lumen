    ...
    pub(super) fn compile_pipelines(&self) -> Result<MetalPipelines, RuntimeError> {
        ...
        macro_rules! make_aligned_pipeline {
            ($name:expr) => {{
                ...
                let func = lib
                    .get_function_with_constants($name, &fcv)
                    .map_err(RuntimeError::Compute)?;
                self.device
                    .new_compute_pipeline_state(&func)
                    .map_err(|e| RuntimeError::Compute(e))?
        ...
        let pipelines = MetalPipelines {
            ...
            dequant_matmul_q8_0_residual_multirow: make_pipeline!(
                "dequant_matmul_q8_0_residual_multirow"
            ),
            ...
            dequant_matmul_q8_0_deferred_residual: make_pipeline!(
                "dequant_matmul_q8_0_deferred_residual"
            ),
            ...
            dequant_matmul_q8_0_deferred_residual_nr2: make_pipeline!(
                "dequant_matmul_q8_0_deferred_residual_nr2"
            ),
            dequant_matmul_q8_0_deferred_bias_nr2: make_pipeline!(
                "dequant_matmul_q8_0_deferred_bias_nr2"
            ),
            ...
            dequant_matmul_q4_0_deferred_residual: make_pipeline!(
                "dequant_matmul_q4_0_deferred_residual"
            ),
            ...
            dequant_matmul_q4_0_deferred_residual_nr2: make_pipeline!(
                "dequant_matmul_q4_0_deferred_residual_nr2"
            ),
            ...
            dequant_tiled_matmul_q4_0_residual_batched: make_pipeline!(
                "dequant_tiled_matmul_q4_0_residual_batched"
            ),
            ...
            dequant_tiled_matmul_q4_1_residual_batched: make_pipeline!(
                "dequant_tiled_matmul_q4_1_residual_batched"
            ),
            ...
            dequant_tiled_matmul_q8_0_k64_splitk: make_pipeline!(
                "dequant_tiled_matmul_q8_0_k64_splitk"
            ),
            ...
            dequant_tiled_matmul_q8_0_k64_residual_batched: make_bc_pipeline!(
                "dequant_tiled_matmul_q8_0_k64_residual_batched"
            ),
            dequant_tiled_matmul_q4_0_k64: make_bc_pipeline!("dequant_tiled_matmul_q4_0_k64"),
            dequant_tiled_matmul_q4_0_k64_residual_batched: make_bc_pipeline!(
                "dequant_tiled_matmul_q4_0_k64_residual_batched"
            ),

            // Joint gate+up+SwiGLU fused kernel (Q8_0).
            dequant_tiled_matmul_q8_0_gate_up_swiglu_fused: make_bc_pipeline!(
                "dequant_tiled_matmul_q8_0_gate_up_swiglu_fused"
            ),
            dequant_tiled_matmul_q8_0_gate_up_swiglu_fused_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q8_0_gate_up_swiglu_fused"
            ),

            // packed-layout kernels (consume runtime-repacked SoA buffers).
            dequant_tiled_matmul_q8_0_k64_residual_batched_packed: make_bc_pipeline!(
                "dequant_tiled_matmul_q8_0_k64_residual_batched_packed"
            ),
            dequant_tiled_matmul_q8_0_k64_residual_batched_packed_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q8_0_k64_residual_batched_packed"
            ),
            dequant_tiled_matmul_q8_0_gate_up_swiglu_fused_packed: make_bc_pipeline!(
                "dequant_tiled_matmul_q8_0_gate_up_swiglu_fused_packed"
            ),
            dequant_tiled_matmul_q8_0_gate_up_swiglu_fused_packed_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q8_0_gate_up_swiglu_fused_packed"
            ),

            // Q4_0 port of fused gate+up+SwiGLU kernel.
            dequant_tiled_matmul_q4_0_gate_up_swiglu_fused: make_bc_pipeline!(
                "dequant_tiled_matmul_q4_0_gate_up_swiglu_fused"
            ),
            dequant_tiled_matmul_q4_0_gate_up_swiglu_fused_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q4_0_gate_up_swiglu_fused"
            ),
            ...
            dequant_tiled_matmul_q8_0_k64_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q8_0_k64"
            ),
            dequant_tiled_matmul_q8_0_k64_residual_batched_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q8_0_k64_residual_batched"
            ),
            dequant_tiled_matmul_q8_0_residual_batched_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q8_0_residual_batched"
            ),
            dequant_tiled_matmul_q4_0_k64_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q4_0_k64"
            ),
            dequant_tiled_matmul_q4_0_k64_residual_batched_aligned: make_aligned_pipeline!(
                "dequant_tiled_matmul_q4_0_k64_residual_batched"
            ),
            tiled_matmul_f16_k64_aligned: make_aligned_pipeline!("tiled_matmul_f16_k64"),
            tiled_matmul_f16_k64_residual_aligned: make_aligned_pipeline!(
                "tiled_matmul_f16_k64_residual"
            ),
            tiled_matmul_bf16_k64_aligned: make_aligned_pipeline!("tiled_matmul_bf16_k64"),
            tiled_matmul_bf16_k64_residual_aligned: make_aligned_pipeline!(
                "tiled_matmul_bf16_k64_residual"
            ),
            // BF16 GDN qkv-proj + attn-gate-proj paired GEMM (BC + aligned).
            tiled_matmul_bf16_k64_qkv_gate_paired: make_bc_pipeline!(
            ...
            bf16_matmul_gate_up_swiglu_fused_aligned: make_aligned_pipeline!(
                "bf16_matmul_gate_up_swiglu_fused"
            ),
            // NR microtile sweep variants of the fused gate+up+SwiGLU kernel.
            bf16_matmul_gate_up_swiglu_fused_nr1: make_bc_pipeline!(
                "bf16_matmul_gate_up_swiglu_fused_nr1"
            ),
            bf16_matmul_gate_up_swiglu_fused_nr1_aligned: make_aligned_pipeline!(
                "bf16_matmul_gate_up_swiglu_fused_nr1"
            ),
            bf16_matmul_gate_up_swiglu_fused_nr4: make_bc_pipeline!(
            ...
            rope_batched_neox: lib
                .get_function("rope_batched_neox")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ...
            rmsnorm_dequant_matmul_q8_0_deferred_nr2: make_pipeline!(
                "rmsnorm_dequant_matmul_q8_0_deferred_nr2"
            ),
            rmsnorm_dequant_matmul_q8_0_deferred_residual_nr2: make_pipeline!(
                "rmsnorm_dequant_matmul_q8_0_deferred_residual_nr2"
            ),
            rmsnorm_dequant_matmul_q4_0_deferred_nr2: make_pipeline!(
                "rmsnorm_dequant_matmul_q4_0_deferred_nr2"
            ),
            rmsnorm_dequant_matmul_q4_0_deferred_residual_nr2: make_pipeline!(
                "rmsnorm_dequant_matmul_q4_0_deferred_residual_nr2"
            ),
            // Fused RMSNorm + F16 matvec NR2
            rmsnorm_matmul_f16_deferred_nr2: make_pipeline!("rmsnorm_matmul_f16_deferred_nr2"),
            rmsnorm_matmul_f16_deferred_residual_nr2: make_pipeline!(
                "rmsnorm_matmul_f16_deferred_residual_nr2"
            ),
            ...
            rmsnorm_ffn_fused_gate_up_swiglu_q8_0_8row: make_pipeline!(
                "rmsnorm_ffn_fused_gate_up_swiglu_q8_0_8row"
            ),
            rmsnorm_ffn_fused_gate_up_swiglu_q4_0_deferred: make_pipeline!(
                "rmsnorm_ffn_fused_gate_up_swiglu_q4_0_deferred"
            ),
            rmsnorm_ffn_fused_gate_up_swiglu_q4_0_8row: make_pipeline!(
                "rmsnorm_ffn_fused_gate_up_swiglu_q4_0_8row"
            ),
            rmsnorm_ffn_fused_gate_up_swiglu_f16_deferred: make_pipeline!(
                "rmsnorm_ffn_fused_gate_up_swiglu_f16_deferred"
            ),
            ffn_fused_gate_up_swiglu_q8_0: make_pipeline!("ffn_fused_gate_up_swiglu_q8_0"),
            ffn_fused_gate_up_swiglu_q8_0_deferred: make_pipeline!(
                "ffn_fused_gate_up_swiglu_q8_0_deferred"
            ),
            ffn_fused_gate_up_swiglu_q4_0: make_pipeline!("ffn_fused_gate_up_swiglu_q4_0"),
            ffn_fused_gate_up_swiglu_q4_0_deferred: make_pipeline!(
                "ffn_fused_gate_up_swiglu_q4_0_deferred"
            ),
            ffn_fused_gate_up_swiglu_q4_1_deferred: make_pipeline!(
                "ffn_fused_gate_up_swiglu_q4_1_deferred"
            ),
            ffn_fused_gate_up_swiglu_f16_deferred: make_pipeline!(
            ...
            moe_router_softmax: lib
                .get_function("moe_router_softmax")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_router_logits_f32: lib
                .get_function("moe_router_logits_f32")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ...
            moe_router_softmax_batched: lib
                ...
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_router_softmax_biased: lib
                .get_function("moe_router_softmax_biased")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_expert_accum: lib
                .get_function("moe_expert_accum")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_expert_accum_batched: lib
                .get_function("moe_expert_accum_batched")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_expert_accum_option_a: lib
                .get_function("moe_expert_accum_option_a")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Expert-grouped prefill index/copy kernels.
            moe_prefill_route_sort: lib
                .get_function("moe_prefill_route_sort")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_prefill_route_sort_par: lib
                .get_function("moe_prefill_route_sort_par")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_prefill_route_sort_atomic: lib
                .get_function("moe_prefill_route_sort_atomic")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_prefill_gather: lib
                .get_function("moe_prefill_gather")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_prefill_gather_vec4: lib
                .get_function("moe_prefill_gather_vec4")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_prefill_scatter_vec4: lib
                .get_function("moe_prefill_scatter_vec4")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_prefill_scatter: lib
                .get_function("moe_prefill_scatter")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_prefill_assign_expert: lib
                .get_function("moe_prefill_assign_expert")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_grouped_gemm_q8_0: lib
                .get_function("moe_grouped_gemm_q8_0")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_grouped_gemm_q8_0_tilemap: lib
                .get_function("moe_grouped_gemm_q8_0_tilemap")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_grouped_gemm_q4_0_tilemap: lib
                .get_function("moe_grouped_gemm_q4_0_tilemap")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_prefill_build_tile_map: lib
                .get_function("moe_prefill_build_tile_map")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Batched MoE expert FFN kernels.
            moe_batched_gate_up_swiglu_q4_0: lib
                .get_function("moe_batched_gate_up_swiglu_q4_0")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_batched_gate_up_swiglu_q4_1: lib
                .get_function("moe_batched_gate_up_swiglu_q4_1")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ...
            moe_batched_down_accum_q4_0: lib
                ...
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_batched_down_accum_q4_1: lib
                .get_function("moe_batched_down_accum_q4_1")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_batched_down_accum_q8_0: lib
                .get_function("moe_batched_down_accum_q8_0")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            moe_batched_down_accum_shared_q8_0: lib
                .get_function("moe_batched_down_accum_shared_q8_0")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ...
            moe_batched_down_accum_shared_q4_0: lib
                ...
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            sigmoid_scale_add: lib
                .get_function("sigmoid_scale_add")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),

            // GatedDeltaNet (linear attention) pipeline states.
            ssm_conv1d_decode: lib
                .get_function("ssm_conv1d_decode")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            l2_normalize_heads: lib
                .get_function("l2_normalize_heads")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            sigmoid_gate: lib
                .get_function("sigmoid_gate")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            silu_elementwise_mul: lib
                .get_function("silu_elementwise_mul")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            gated_delta_net_state_update: lib
                .get_function("gated_delta_net_state_update")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            gated_delta_net_output: lib
                .get_function("gated_delta_net_output")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),

            // Additional GDN pipeline states for full forward pass.
            gated_delta_net_state_update_v2: lib
                .get_function("gated_delta_net_state_update_v2")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            gdn_compute_gates: lib
                .get_function("gdn_compute_gates")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            elementwise_mul_f32: lib
                .get_function("elementwise_mul_f32")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ssm_l2_norm_scale: lib
                .get_function("ssm_l2_norm_scale")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),

            // Fused element-wise kernels for GDN dispatch reduction.
            sigmoid_mul_fused: lib
                .get_function("sigmoid_mul_fused")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            residual_add_copy: lib
                .get_function("residual_add_copy")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            l2_normalize_qk: lib
                .get_function("l2_normalize_qk")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),

            // SiLU activation (in-place) for post-conv1d GDN activation.
            silu_inplace: lib
                .get_function("silu_inplace")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Fused Conv1D + SiLU for GDN decode.
            ssm_conv1d_silu_decode: lib
                .get_function("ssm_conv1d_silu_decode")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),

            // Q+gate de-interleave for Qwen3.5 full-attention layers.
            deinterleave_qgate: lib
                .get_function("deinterleave_qgate")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Per-head RMSNorm for Q and K (Qwen3.5 full-attention layers).
            rmsnorm_per_head: lib
                .get_function("rmsnorm_per_head")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Sigmoid-scale for shared expert gating.
            sigmoid_scale_buffer: lib
                .get_function("sigmoid_scale_buffer")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Batched sigmoid-scale-add for shared expert gating during prefill.
            sigmoid_scale_add_batched: lib
                .get_function("sigmoid_scale_add_batched")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),

            // Fused GDN mega-kernels for further dispatch reduction.
            gdn_state_output_norm: lib
                .get_function("gdn_state_output_norm")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            dequant_matmul_q8_0_deferred_residual_copy: lib
                .get_function("dequant_matmul_q8_0_deferred_residual_copy")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            dequant_matmul_q8_0_deferred_residual_copy_nr2: lib
                .get_function("dequant_matmul_q8_0_deferred_residual_copy_nr2")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            dequant_matmul_q4_0_deferred_residual_copy: lib
                .get_function("dequant_matmul_q4_0_deferred_residual_copy")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            dequant_matmul_q4_0_deferred_residual_copy_nr2: lib
                .get_function("dequant_matmul_q4_0_deferred_residual_copy_nr2")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ...
            gdn_state_output_norm_l2: lib
                .get_function("gdn_state_output_norm_l2")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ...
            gdn_decode_norm_scale: lib
                .get_function("gdn_decode_norm_scale")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Fused Conv1D+SiLU + L2-normalize + state-update + output + RMSNorm
            gdn_state_output_norm_l2_conv: lib
                .get_function("gdn_state_output_norm_l2_conv")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Full GDN decode megakernel: Conv1D+SiLU + inline gates + L2 + state + output + RMSNorm
            gdn_decode_megakernel: lib
                .get_function("gdn_decode_megakernel")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Fused SiLU-gated Q8_0 matvec + residual + copy
            dequant_matmul_q8_0_silu_deferred_residual_copy_nr2: lib
                .get_function("dequant_matmul_q8_0_silu_deferred_residual_copy_nr2")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Fused SiLU-gated Q4_0 matvec + residual + copy
            dequant_matmul_q4_0_silu_deferred_residual_copy_nr2: lib
                .get_function("dequant_matmul_q4_0_silu_deferred_residual_copy_nr2")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            // Fused dual alpha+beta RMSNorm+matvec+gates for GDN decode
            dequant_matmul_q8_0_dual_gates_nr2: lib
                .get_function("dequant_matmul_q8_0_dual_gates_nr2")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),

            // Batched GDN prefill kernels
            gdn_prefill_state_output_norm: lib
                .get_function("gdn_prefill_state_output_norm")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            gdn_prefill_fused: lib
                .get_function("gdn_prefill_fused")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            gdn_prefill_fused_v2: lib
                .get_function("gdn_prefill_fused_v2")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ...
            gdn_prefill_norm_gate: lib
                ...
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ssm_conv1d_prefill: lib
                .get_function("ssm_conv1d_prefill")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ssm_conv1d_silu_prefill: lib
                .get_function("ssm_conv1d_silu_prefill")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ssm_conv1d_silu_prefill_parallel: lib
                .get_function("ssm_conv1d_silu_prefill_parallel")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ssm_conv1d_state_update: lib
                .get_function("ssm_conv1d_state_update")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            l2_normalize_heads_batched: lib
                .get_function("l2_normalize_heads_batched")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            ...
            gdn_compute_gates_batched: lib
                ...
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            dequant_batched_matvec_q8_0: lib
                .get_function("dequant_batched_matvec_q8_0")
                .and_then(|f| self.device.new_compute_pipeline_state(&f).ok()),
            dequant_batched_matvec_q8_0_dual: lib
