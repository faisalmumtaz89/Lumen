// VENDORED VERBATIM from Lumen commit dd6b12f (branch perf/attn-splitk-partial-warp).
// Reproduced byte-for-byte by `git show <commit>:crates/lumen-runtime/src/cuda/shaders/attention_decode_splitk.cu`
// so the A/B harness compiles the historical kernel `attention_decode_splitk_partial_warp`
// in its original translation unit (same helpers, same codegen context).
// The comments below carry that commit's STALE geometry (24/8 heads, head_dim 128);
// the measured shape is 24 Q heads / 4 KV heads / head_dim 256. Do not edit this file.
// ==========================================================================
// ==========================================================================
