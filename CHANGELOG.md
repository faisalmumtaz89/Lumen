...
- **`LUMEN_CUDA_ATTN_SPLITK_GQA6`, a GQA-shared decode-attention pair
  ...
  **82.5 → 85.5 tok/s** at 1,024 in / 128 out (five runs each leg, CV
  0.02 % and 0.03 %), and **+3.6 %** at a 1,300-token context (86.6 tok/s),
  +3.3 % at 330 and +3.7 % at 2,600.
  ...
  **10.0 µs against 26.3 µs** with the working set warm in L2 and **16.4 µs
  against 49.2 µs** with it evicted to DRAM, the two states that bracket live
