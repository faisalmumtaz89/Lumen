...
Lumen runs **LLM inference in Rust, for Apple Silicon and NVIDIA CUDA**. Built from scratch with zero ML dependencies — no PyTorch, no ONNX, no Python runtime. v1 (current) ships verified support for **Qwen3.5-9B**, **Qwen3.8-27B**, and **Qwen3.5-MoE 35B-A3B**; additional model families are planned.
